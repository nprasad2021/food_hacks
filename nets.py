...
def vggnet(input_shape=(224,224,3), freeze=0):
    model = vgg16.VGG16(weights='imagenet', input_shape=input_shape, include_top=False)
    return model

def resnet(input_shape=(224,224,3), freeze=0):
    model = resnet50.ResNet50(weights='imagenet', input_shape=input_shape, include_top=False)
    return model

def inceptionv3(input_shape=(224,224,3), freeze=0):
    model = inception_v3.InceptionV3(weights='imagenet', input_shape=input_shape, include_top=False)
    return model

def inception_res(input_shape=(224,224,3), freeze=0):
    model = inception_resnet_v2.InceptionResNetV2(weights='imagenet', input_shape=input_shape, include_top=False)
    return model
...
def all_nets():
    return {'vggnet':vggnet,'resnet':resnet, 'inceptionv3':inceptionv3,
